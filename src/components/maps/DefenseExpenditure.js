...
export default DefenseExpenditure;
>>>>>>> 6c2f2614 (Added a choropleth map for defense expenditure by country by year with an integrated line chart showing US, China, Russia data. Reorganized the dashboard, moved the original choropleth map and proportional map to the conclusion and replaced with the DefenseExpenditure map in the Introduction)
